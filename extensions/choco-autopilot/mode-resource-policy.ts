...
const DESIGN_POLICY: ModeResourcePolicy = {
  ...
  extensionGuidance: [
    ...
    "Apply taste-ko only as design-mode Korean typography/copy guidance; do not force standalone HTML or landing-page defaults when the project stack or artifact track differs.",
    "Use gstack QA when browser, UI, screenshot, responsive, or deployed-flow verification is relevant.",
    "Use slides-grab or frontend-slides only for presentation/deck artifacts; do not apply app-state checklists to slide decks.",
  ...
  toolPriority: [
    "artifact-track classification before visual direction",
    ...
    "Korean line-break and typography QA before visual polish",
    "gstack QA before Confidence: High for UI/browser behavior",
  ],
  processPriorities: [
    "anti-slop specificity before generic modern/clean defaults",
    "user journey and information hierarchy before decoration",
    "brand constraints before component styling",
    "artifact-specific UX before reusable app checklists",
