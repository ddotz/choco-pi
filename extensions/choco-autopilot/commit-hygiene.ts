...
export function buildCommitHygieneGuidance(): string {
  return [
    ...
    "- Exclude unnecessary development analysis files, Superpowers runtime artifacts, `.pi/agent-runs`, `.pi/sessions`, `.pi/todos.json`, private/personal files, secrets, generated output, caches, logs, and unneeded dotfiles.",
