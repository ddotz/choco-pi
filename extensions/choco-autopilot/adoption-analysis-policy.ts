...
export function buildAdoptionAnalysisModeGuidance(): string {
  ...
  return [
    ...
    "Adoption-analysis adds stricter quality gates only when the task is primarily about whether and how much external source/package/repo material should be adopted into choco-pi.",
    "",
    resourcePolicy,
    "",
    ...
    "2. Compare it against choco-pi's default-root all-purpose philosophy, Pi-native runtime model, mode isolation invariant, and current source registry behavior.",
    ...
    "5. Track sources only when their code/design is actually reflected into choco-pi or the user explicitly asks to track them.",
    "",
    ...
    "- Fit review: choco-pi philosophy, Pi-native fit, default behavior impact, mode isolation, duplication, and maintenance cost.",
