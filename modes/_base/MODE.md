...
Shared invariants for every choco-pi work mode.

- Default is the root all-purpose generalist mode and the canonical expression of choco-pi philosophy; specialized modes add isolated overlays while the shared structural gates remain intact.
