...
Default is the root all-purpose generalist mode. It is the mode that best preserves the ddotz-pi philosophy and acts as the source baseline for every specialized mode.
