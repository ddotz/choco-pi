...
- For PRD, 기획서, 제품기획, product requirements, or product spec requests, use the advanced `prd-architect` skill: analyze context first, proceed with explicit assumptions, ask critical questions only, and avoid beginner interview or AskUserQuestion-first flows.
